...
uint8_t TM_MFRC522_ReadRegister(uint8_t addr) {
	...
	uint8_t val=0x00;
/*
	SPI_Driver_Set_Slave_Select_Low(SPI_DRIVER_1);

	SPI_Driver_Send_Data(SPI_DRIVER_1, ((addr << 1) & 0x7E) | 0x80);
	val = SPI_Driver_Send_Data(SPI_DRIVER_1, MFRC522_DUMMY);

	SPI_Driver_Set_Slave_Select_High(SPI_DRIVER_1);*/
